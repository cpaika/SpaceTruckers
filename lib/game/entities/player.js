...
EntityPlayer = ig.Entity.extend({
    ...
    drawThruster: function()
    {
        ...
        context.beginPath();
        context.moveTo(this.pos.x + this.size.x/3 - xOff, this.pos.y + this.size.y + 3);
        context.lineTo(this.pos.x + (this.size.x/2) - xOff , this.pos.y + this.size.y + endPoint);
        context.strokeStyle = "#FFFFFF";
        context.stroke(); 

        context.beginPath();
        context.moveTo(this.pos.x + this.size.x - this.size.x/3 - xOff, this.pos.y + this.size.y + 3);
        context.lineTo(this.pos.x + this.size.x - (this.size.x/2) - xOff, this.pos.y + this.size.y + endPoint);
        context.strokeStyle = "#FFFFFF";
        context.stroke();
    },
    checkCollision()
